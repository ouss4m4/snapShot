...
const SinglePost = ({ post, onCommentAdd }) => {
    return (<div style={{width : '90vw', margin : 'auto'}}>
        <Card >
            <CardHeader
            ...
            <CardActions>
                <FlatButton ><i className='fa fa-heart'></i> Like </FlatButton>
                <FlatButton ><i className="fa fa-comments" aria-hidden="true"></i> Comments {post.comments.length} </FlatButton>
            </CardActions>
        </Card>
    </div>);
};
